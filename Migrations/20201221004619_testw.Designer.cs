...
namespace ph_UserEnv.Migrations
{
    ...
    [Migration("20201221004619_testw")]
    partial class testw
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ph_UserEnv.Models.Contact", b =>
                {
                    ...
                    b.Property<string>("contact1Id")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");

                    b.Property<string>("contact2Id")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("ph_UserEnv.Models.Contact", b =>
                {
                    b.HasOne("ph_UserEnv.Authentication.ApplicationUser", "contact1")
                        .WithMany()
                        .HasForeignKey("contact1Id");

                    b.HasOne("ph_UserEnv.Authentication.ApplicationUser", "contact2")
                        .WithMany()
